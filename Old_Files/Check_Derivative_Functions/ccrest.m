...
x(3:5,1) = States_0.ISO; %Overland Reservoirs x 3 (mm)
...
for tstep = 1:length(F)
    ...
    M2(tstep) = (a(3) - x(1,tstep) - (a(3)*((1-(x(1,tstep)/a(3)))^(1/(1+a(7)))-(M1(tstep)/(a(3)*(1+a(7)))))^(1+a(7)))/approx_f2)*(1/(approx_f3*approx_f1));
